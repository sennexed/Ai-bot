...
class ControlPanel(discord.ui.View):
    ...
    @discord.ui.button(label="Set AI Strictness HIGH", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="Lockdown Channel", style=discord.ButtonStyle.danger)
...
class Moderation(commands.Cog):
    ...
    async def panel(self, interaction: discord.Interaction):
        ...
        if interaction.channel.id != int(settings[1]):
            await interaction.response.send_message("Use this in the configured panel channel.", ephemeral=True)
            return
